...
export default function UniformeOficial () {
    ...
    return (
        <section ref={rootRef} className={styles.container}>
            <img className={styles.fondo} src="/CV/assets/geovanny/fondo-uniforme-oficial.png" alt="Fondo" />
            <h2 className={`${styles.title} ${styles.reveal}`}>UNIFORME OFICIAL</h2>
            <img className={`${styles.logo} ${styles.reveal}`} src="/CV/assets/geovanny/logo_rs_racing.png" alt="Logo RS PRO RACE RACING" />
            ...
            <img className={`${styles.img} ${styles.reveal}`} src="/CV/assets/geovanny/img-uniforme-oficial.png" alt="Imagen modelo" onClick={() => setShowModal(true)}/>

            {showModal && (
                <div className={styles.modal} onClick={() => setShowModal(false)}>
                    <img className={styles.modalImage} src="/CV/assets/geovanny/img-uniforme-oficial.png" alt="Imagen ampliada" />
                </div>
            )}
        </section>
    );
